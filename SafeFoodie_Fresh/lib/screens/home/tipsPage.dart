                  ...
                  Container(
                   ...
                   padding: const EdgeInsets.all(10),
                    child: RichText(
                          ...
                          textScaleFactor: .7, // The number of font pixels for each logical pixel
                          text: const TextSpan(
                            text: 'How to store food to last longer  \n', style: TextStyle(fontSize: 20),
                            children: <TextSpan>[
                              TextSpan(
                                //bullet points
                                  text: '\u2022   Store milk at the back of the fridge to minimize spoilage.\n'
                    ...
                    child: RichText(
                          ...
                          text: const TextSpan(
                            ...
                            children: <TextSpan>[
                              //bullet points
                              TextSpan(
                                  text: '\u2022   Sugar never expires if stored properly in a dry, cool place.\n'
