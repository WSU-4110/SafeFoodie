...
void main() {
  testWidgets('Find a Text Widget!', (wTester) async {
    await wTester.pumpWidget(const MaterialApp(
      home: Scaffold(
        body: Text('Push the buttons below to create new notifications'),
      ),
    ));

    expect(find.text('Push the buttons below to create new notifications'),
        findsOneWidget);
  });
  ...
  testWidgets('MyHomePage has a Title!', (wTester) async {
    await wTester
        .pumpWidget(const MyHomePage(title: 'SafeFoodie Food Recall Example'));

    //find the given title!
    final titleFind = find.text('SafeFoodie Food Recall Example');
